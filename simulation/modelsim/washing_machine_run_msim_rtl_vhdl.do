...
vcom -93 -work work {E:/from HD/University/2022-2023-2/VHDL/lab/projects/washing_machine/state_controller.vhd}

vcom -93 -work work {E:/from HD/University/2022-2023-2/VHDL/lab/projects/washing_machine/state_controller_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L maxv -L rtl_work -L work -voptargs="+acc"  state_controller_tb
